...
const Home = () => {
  return (
    <Container>
      ...
      >
        <defs>
          <circle id="react-path-7" cx="120" cy="120" r="120"></circle>
          <path
          ...
          >
            <g transform="translate(825.000000, 1100.000000)">
              ...
              <mask id="react-mask-11" fill="white">
                <use xlinkHref="#react-path-8"></use>
              </mask>
              <g id="Mask"></g>
              <g
                id="Avataaar"
              ...
              >
                <g id="Body" transform="translate(32.000000, 36.000000)">
                  ...
                  <use fill="#D0C6AC" xlinkHref="#react-path-9"></use>
                  <g
                    id="Skin/????-03-Brown"
                ...
                >
                  ...
                  <use
                    ...
                    fill="#B7C1DB"
                    fill-rule="evenodd"
                    xlinkHref="#react-path-15"
                  ></use>
                  <g
                    id="Color/Palette/Gray-01"
                    mask="url(#react-mask-16)"
                    fill-rule="evenodd"
                    fill="#262E33"
                  >
                    <rect
                ...
                >
                  ...
                  >
                    ...
                    <mask id="react-mask-20" fill="white">
                      <use xlinkHref="#react-path-19"></use>
                    </mask>
                    <use
                      id="Mouth"
                ...
                <g id="Top" stroke-width="1" fill-rule="evenodd">
                  ...
                  <mask id="react-mask-28" fill="white">
                    <use xlinkHref="#react-path-30"></use>
                  </mask>
                  <g id="Mask"></g>
                  <g id="Top/Short-Hair/Short-Flat" mask="url(#react-mask-28)">
                    <g transform="translate(-1.000000, 0.000000)">
                      ...
                      >
                        ...
                        <mask id="react-mask-33" fill="white">
                          <use xlinkHref="#react-path-34"></use>
                        </mask>
                        <use
                          id="Lite-Beard"
                          fill="#331B0C"
                          fill-rule="evenodd"
                          xlinkHref="#react-path-34"
                        ></use>
                        <g
                          id="Color/Hair/Brown"
                      ...
                      <mask id="react-mask-27" fill="white">
                        <use xlinkHref="#react-path-29"></use>
                      </mask>
                      <use
                        id="Short-Hair"
                        stroke="none"
                        fill="#1F3140"
                        fill-rule="evenodd"
                        xlinkHref="#react-path-29"
                      ></use>
                      <g
                        id="Skin/????-03-Brown"
                        mask="url(#react-mask-27)"
                        fill="#4A312C"
                      >
                        <g
