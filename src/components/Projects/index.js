...
const projects = [
  ...
  },
  {
    ...
    description:
      'Jammming is a Spotify playlist creator, created with React Class Components. It is one of my first major projects using a RESTful API to fetch songs and to save users desired playlist to their Spotify account.',
  },
  {
    h2: 'Movie Database',
    img: moviedb,
